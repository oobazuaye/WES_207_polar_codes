...
int main()
{
    ...
    */
    ...
    simulatePolarBERCurve(1, 5, MAX_NUM_BITS);
    /*
    ...
    simulateListPolarBERCurve(1, 5, MAX_NUM_BITS, MAX_NUM_PATHS);
    */
    //simulateMultiListPolarBERCurve(1, 6, MAX_NUM_BITS, MAX_NUM_PATHS);
